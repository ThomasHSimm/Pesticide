...
def main(save_dir=".\\src\\utils\\map_data"):
    ...
    url_data_paths = [
        "https://www.doogal.co.uk/kml/counties/Counties.kml",
    ...
    url_KML_map(url_data_paths, "combined_json", doScotWales=country, save_dir=save_dir)
...
def url_KML_map(url_data_paths, json_fname, doScotWales=[False], save_dir="./map_data"):
    """
...
def load_pcode_csvs():
    ...
    file_paths = [
        ".\\src\\utils\\map_data\\England1 postcodes.csv",
    ...
    for file in file_paths:
        ...
        if re.search(r"NRScotland-SmallUser", file):
            ...
            df_temp.rename(
                columns={
                    "ScottishParliamentaryRegion2021Code": "District Code",
                    "CensusPopulationCount2011": "Population",
                },
                inplace=True,
            )
...
def _postcodeDF_additionalProcessing(postcode_df):
    ...
    country = "Wales"
    postcode_df.loc[postcode_df["Country"] == country, "mapArea"] = postcode_df.loc[
        postcode_df["Country"] == country, "District"
    ]
    ...
    postcode_df.loc[postcode_df["Country"] == country, "mapArea"] = postcode_df.loc[
        postcode_df["Country"] == country, "District Code"
    ]
